...
export default function EstateDashboard() {
  ...
  return (
    <LayoutWrapper menuOpen={menuOpen}>
      ...
      {/* MAIN PAGE — fixed background, only chat scrolls */}
      <main
        className="flex-1 flex flex-col justify-between relative overflow-hidden w-full h-screen"
        style={{
      ...
      >
        ...
        <div
          ...
          className="flex-1 overflow-y-auto px-4 md:px-10 pt-20 pb-32 space-y-4 scroll-smooth max-w-3xl mx-auto w-full"
        >
          {messages.map((msg, i) => {
