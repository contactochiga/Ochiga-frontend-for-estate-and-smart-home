...
export default function PaymentsOverviewCard() {
  return (
    <div className="rounded-xl shadow-lg p-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      <h2 className="text-lg font-semibold mb-4">Payments Overview</h2>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {/* Total Collected */}
        <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 flex flex-col items-start">
