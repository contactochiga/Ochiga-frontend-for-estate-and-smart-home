...
export default function AIDashboard() {
  ...
  return (
    <div className="relative flex flex-col h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 text-white overflow-hidden">
      ...
      {/* ---------------------------
    Dynamic Smart Suggestion Box
   --------------------------- */}
<DynamicSuggestionCard
  userActions={messages
...
{/* ---------------------------
    Footer Chat Input
   --------------------------- */}
<footer className="w-full bg-gray-900/80 backdrop-blur-lg border-t border-gray-700 px-4 py-3 fixed bottom-0 left-0">
